...
export default function WhyChoose() {
  ...
  return (
    <section  className="py-8 px-4 max-w-6xl mx-auto" ref={ref}>
      <div className="text-center mb-8">
        <h3 className="text-3xl font-extrabold">Why Choose ChefBazar?</h3>
        <p className="text-gray-600 mt-2 max-w-2xl mx-auto">Quality meals prepared by local chefs — honest prices and real flavors.</p>
      </div>
  ...
  {features.map((f) => (
    <motion.div
      ...
      className=" feature-item relative bg-white rounded-3xl p-6 shadow-lg cursor-pointer overflow-hidden border border-gray-100 group"
    >
      {/* Top accent circle */}
      <div className="absolute -top-6 left-6 w-12 h-12 bg-linear-to-r from-emerald-400 to-lime-400 rounded-full flex items-center justify-center text-white text-xl font-bold shadow-lg">
        {f.icon ? f.icon : "★"}
      </div>

      <div className="mt-8">
        <h4 className="font-semibold text-lg text-gray-800 mb-2">{f.title}</h4>
